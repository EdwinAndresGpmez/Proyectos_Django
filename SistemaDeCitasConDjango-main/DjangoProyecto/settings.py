...
SECRET_KEY = 'django-insecure-@g7n@5kald+5i+-3&z=mj#b(4^apa5gfhprbpcm8ogsa$u5)lf'
...
CACHES = {
    'default': {
        ...
        'LOCATION': BASE_DIR / 'cache',  # Ubicación del caché
        'OPTIONS': {
            'MAX_ENTRIES': 1000,  # Número máximo de entradas de caché antes de que empiecen a eliminarse
        },
        'TIMEOUT': 300,  # Tiempo en segundos para que expire cada entrada de caché
    }
}
