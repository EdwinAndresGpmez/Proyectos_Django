...
def editar_servicios(request, id_servicio):
    if request.method == 'POST':
        ...
        print("Profesionales seleccionados:", profesionales_ids)  # Verifica si los profesionales están llegando correctamente
        ...
        if profesionales_ids:
            ...
            print("Profesionales encontrados:", profesionales)  # Verifica si se encuentran correctamente los profesionales
        ...
        return JsonResponse({'status': 'success', 'message': 'Servicio editado correctamente.'})
    else:
        return JsonResponse({'status': 'error', 'message': 'Método no permitido.'})
